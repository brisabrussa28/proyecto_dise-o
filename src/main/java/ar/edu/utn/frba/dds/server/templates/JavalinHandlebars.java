  ...
  public JavalinHandlebars() {
    ...
    this.handlebars.registerHelper(
        "eq", (Object a, Options options) -> {
          ...
          return Objects.equals(a, b) || (a != null && b != null && a.toString()
                                                                     .equals(b.toString()));
        }
    );
    ...
    // 4. Helper "add": Suma
    this.handlebars.registerHelper(
        "add", (Object a, Options options) -> {
          try {
            int x = Integer.parseInt(a.toString());
            int y = Integer.parseInt(options.param(0)
                                            .toString());
            return x + y;
          } catch (Exception e) {
            return a;
    ...
    this.handlebars.registerHelper(
        "subtract", (Object a, Options options) -> {
          try {
            int x = Integer.parseInt(a.toString());
            int y = Integer.parseInt(options.param(0)
                                            .toString());
    ...
    this.handlebars.registerHelper(
        "range", (Object start, Options options) -> {
          int s = Integer.parseInt(start.toString());
          int e = Integer.parseInt(options.param(0)
                                          .toString());
    ...
    handlebars.registerHelper(
        "charAt", (Object context, Options options) -> {
          if (context == null) {
            return "";
          }
          String texto = context.toString();
          int index = options.param(0, 0);
